...
#define JACKET_2_SND_TRIGGER    7
#define JACKET_3_SND_TRIGGER    8
#define JACKET_4_SND_TRIGGER    9
#define JACKET_ALL_SND_TRIGGER  10

#define MY_ID        JACKET_ID_1   /* change for jacket */
...
void setup() {
  ...
  pinMode(JACKET_2_SND_TRIGGER, OUTPUT);
  pinMode(JACKET_3_SND_TRIGGER, OUTPUT);
  pinMode(JACKET_4_SND_TRIGGER, OUTPUT);
  pinMode(JACKET_ALL_SND_TRIGGER, OUTPUT);
...
#endif
      digitalWrite(JACKET_2_SND_TRIGGER, HIGH);
      delay(10);
      digitalWrite(JACKET_2_SND_TRIGGER, LOW);
  }
...
#endif
      digitalWrite(JACKET_3_SND_TRIGGER, HIGH);
      delay(10);
      digitalWrite(JACKET_3_SND_TRIGGER, LOW);
  }
...
#endif
      digitalWrite(JACKET_4_SND_TRIGGER, HIGH);
      delay(10);
      digitalWrite(JACKET_4_SND_TRIGGER, LOW);
    }
  } 
}
